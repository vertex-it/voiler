<div class="flex">
    <div class="dropdown">
        <button class="btn btn-transparent rounded-full hover:bg-gray-200 px-2 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            @if(method_exists($model, 'trashed') && $model->trashed())
                @can($resource['roles']['restore'])
                    <x-modal-button
                        ...
                        buttonClass="dropdown-item text-left"
