...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable($tableNames['role_has_permissions'])) {
            Schema::table($tableNames['role_has_permissions'],
                function(Blueprint $table) use ($pivotRole, $pivotPermission) {
                    $table->dropForeign([$pivotPermission]);
                    $table->dropForeign([$pivotRole]);
        ...
        if (Schema::hasTable($tableNames['model_has_permissions'])) {
            Schema::table($tableNames['model_has_permissions'],
        ...
        if (Schema::hasTable($tableNames['model_has_roles'])) {
            Schema::table($tableNames['model_has_roles'],
